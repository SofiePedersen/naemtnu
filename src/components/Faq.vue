  ...
  const infoTabs = [
    {
      ...
      answer: 'Vi har åbent mandag–fredag fra 9 til 17. I weekenden er vi tilgængelige via e-mail.'
    },
    {
      id: 2,
      question: 'Hvordan kommer jeg i kontakt med jer?',
      answer: 'Du kan skrive til os på kontakt@eksempel.dk eller ringe på +45 12 34 56 78.'
    },
    {
      id: 3,
      question: 'Hvad koster det at bruge jeres service?',
      answer: 'Vi tilbyder en gratis prøveperiode i 14 dage. Herefter starter priserne fra 99 kr./md.'
    },
    {
      id: 4,
      question: 'Kan jeg opsige når som helst?',
      answer: 'Ja, du kan til enhver tid opsige dit abonnement uden bindingsperiode.'
    },
    {
      id: 5,
      question: 'Hvad sker der med mine data?',
      answer: 'Vi opbevarer dine data sikkert og deler dem aldrig med tredjepart. Læs mere i vores privatlivspolitik.'
    },
    {
      id: 6,
      question: 'Tilbyder I support på dansk?',
      answer: 'Ja, vores supportteam svarer på dansk og er tilgængeligt på alle hverdage.'
    }
  ]
</script>
  ...
  <main>
    <div class="faq-wrapper">
      <div class="faq-wrapper__image-wrapper">
        <img src="@/assets/images/tore-og-sebastian.webp" alt="Billedet viser Tore og Sebastian fra næmt.nu, som sidder og smiler ved en bærbar" class="faq-wrapper__image" />
      </div>
      ...
      <div class="faq-wrapper__accordion">
        ...
        <div v-for="tab in infoTabs" :key="tab.id" class="accordion-item">
          ...
          <button class="accordion-item__header" :class="{ 'is-open': activeId === tab.id }" @click="toggle(tab.id)">
          ...
          <div class="accordion-item__body" :class="{ 'is-open': activeId === tab.id }">
            <p>{{ tab.answer }}</p>
          </div>
        </div>
      </div>
